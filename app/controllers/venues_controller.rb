class VenuesController < ApplicationController
  ...
  def index
    ...
    @venues = @q.result(distinct: true).includes(:user, :bookmarks,
                                                 :best_dishes, :cuisine).page(params[:page]).per(10)
  end
  ...
  def venue_params
    params.require(:venue).permit(:state, :city, :neighborhood, :cuisine_id,
                                  :user_id)
  end
end
