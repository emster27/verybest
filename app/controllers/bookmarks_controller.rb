class BookmarksController < ApplicationController
  ...
  def index
    ...
    @bookmarks = @q.result(:distinct => true).includes(:user, :venue, :dish, :food_type).page(params[:page]).per(10)
  end
  ...
  private
    ...
    def bookmark_params
      params.require(:bookmark).permit(:user_id, :venue_id, :notes, :dish_id)
    end
end
